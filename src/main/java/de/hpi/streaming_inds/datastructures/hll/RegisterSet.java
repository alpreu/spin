...
public class RegisterSet implements Serializable {
    ...
    /**
     * Create a new RegisterSet instance by deep-copying another one.
     * @param other - the RegisterSet instance to copy
     */
    public RegisterSet(RegisterSet other) {
        this.count = other.count;
        this.size = other.size;

        int[] temp = new int[other.size];
        System.arraycopy(other.M, 0, temp, 0, other.size);
        this.M = temp;
    }
